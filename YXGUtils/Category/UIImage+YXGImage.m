...
@implementation UIImage (YXGImage)

//高效添加圆角图片
- (UIImage*)yxg_imageAddCornerWithRadius:(CGFloat)radius andSize:(CGSize)size{
...
//截屏
+(instancetype)yxg_snapshotCurrentScreen{
...
+(UIImage *)yxg_GetRoundImagewithImage:(UIImage *)image {
...
- (UIColor *)yxg_colorAtPixel:(CGPoint)point
{
...
//生成一张纯色的图片
- (UIImage *)yxg_imageWithColor:(UIColor *)color
{
...
/** 获得灰度图 */
- (UIImage *)yxg_convertToGrayImage
{
...
- (UIImage *)yxg_imageWithTitle:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor {
    //画布大小
