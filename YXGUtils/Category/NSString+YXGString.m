...
#import "NSString+YXGString.h"

@implementation NSString (YXGString)
...
- (NSString*)yxg_substringWithinBoundsLeft:(NSString*)strLeft right:(NSString*)strRight
{
    NSRange rangeSub;
    NSString *strSub;
...
/**
 ...
 @return 返回的中文数字
 */
+(NSString *)yxg_translation:(NSString *)arebic
{
    NSString *str = arebic;
...
- (NSString*)yxg_reverseWordsInString:(NSString*)str
{
...
+ (NSString *)yxg_transform:(NSString *)chinese
{
