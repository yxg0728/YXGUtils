...
- (UIView *)yxg_findSuperViewWithClass:(Class)clazz;
{
    ...
    {
        return [self.superview yxg_findSuperViewWithClass:clazz];
    }
}
...
- (UIView *)yxg_findFirstResponder
{
    ...
    {
        UIView *fv = [v yxg_findFirstResponder];
        if (fv)
        {
            return fv;
        }
...
- (NSArray *)yxg_allSubviews
{
    ...
    {
        [array addObjectsFromArray:[view yxg_allSubviews]];
    }
...
{
    return [self yxg_loadViewFromNibWithName:NSStringFromClass([self class])];
}

+ (instancetype)yxg_loadViewFromNibWithName:(NSString *)nibName
{
    return [self yxg_loadViewFromNibWithName:nibName owner:nil];
}

+ (instancetype)yxg_loadViewFromNibWithName:(NSString *)nibName owner:(id)owner
{
    return [self yxg_loadViewFromNibWithName:nibName owner:owner bundle:[NSBundle mainBundle]];
}
